 ...
 * @root: root of the tree
 * @value: node with this value to remove
 * Return: the new root of the AVL tree after removal and balancing
 */
avl_t *avl_remove(avl_t *root, int value)
{
	...
	/* Remove the node as if it were a BST */
	bst_t *new_root = bst_remove((bst_t *)root, value);
